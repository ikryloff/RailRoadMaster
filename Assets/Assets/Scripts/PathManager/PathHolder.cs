...
public class PathHolder : Singleton<PathHolder>
{
    ...
    public static TrackCircuit tc10;
    ...
    private void Awake()
    {
        ...
        node10 = new Node(null, tcsw22, tc10, tcsw18, null, false, TC_10_ID);
        ...
        nodeSw22 = new Node(tcsw14, tc14, tcsw22, tc10, tc10, true, TC_SW_22_ID);
